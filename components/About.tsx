    ...
    <div className="bg-white max-w-4xl mx-auto  shadow-md rounded-lg pl-10 pt-8">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-700 mb-4">
          ...
          urna volutpat pendisse enim facilisi diam ut sed.
        </p>
        <p className="text-gray-700 mb-4">
          Diam praesent massa dapibus magna aliquam a dictumst volutpat. Egestas
          vitae pellentesque auctor amet. Nunc sagittis libero adipiscing cursus
          felis pellentesque interdum. Odio cursus pharetra velit in senectus
          enim dui. Turpis tristique placerat interdum eu volutpat.
        </p>
